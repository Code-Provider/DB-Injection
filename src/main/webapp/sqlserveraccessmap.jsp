...
<table class="table" value = "${table.sqlservertable}*${table.accesstable}" id = "table${count}">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Access : ${table.accesstable}</th>
  ...
  <c:forEach var = "sqlserverfield" items = "${table.sqlserverfields}">
  	 <tr id = "sqlserverfield${co}">
  	 
  	 <th scope="row" value = "${sqlserverfield}" id = "${count}th${co}"><c:out value="${sqlserverfield}"/></th>
  	 
  	 
  	 
  	 <td><select class="custom-select" id = "${count}td${co}">
  	 <option value = "No Mapping">No Mapping</option>
  	 <c:forEach var = "accessfield" items = "${table.accessfields}">
     <option value = "${accessfield}"><c:out value="${accessfield}"/></option>
     </c:forEach>
...
<input type="hidden" name="type" id="tableTextId" value = "sqlserveraccess"/>
