...
<script type="text/javascript">
  ...
  {
	//mysqltable,mysql2table:mysqlfield1;mysql2field1-mysqlfield2;mysql2field2   / mysqltable2,
...
<table class="table" value = "${table.mysqltable}*${table.mysql2table}" id = "table${count}">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">mysql2 : ${table.mysql2table}</th>
  ...
  <c:forEach var = "mysqlfield" items = "${table.mysqlfields}">
  	 ...
  	 <c:forEach var = "mysql2field" items = "${table.mysql2fields}">
     <option value = "${mysql2field}"><c:out value="${mysql2field}"/></option>
     </c:forEach>
...
<input type="hidden" name="type" id="typee" value = "mysqlmysql2"/>
